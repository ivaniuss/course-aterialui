...
import {Typography, CssBaseline, AppBar, Button, Card, CardActions, CardContent, CardMedia, Grid, Toolbar, Container} from '@material-ui/core';
        ...
        <main>
            ...
            <Container className={classes.cardGrid} maxWidth='md'>
                <Grid container spacing={4}>
                    {cards.map((card) => (
                        <Grid item key={card} xs={12} sm={6} md={4} align='center'>
